package com.app.matrimony.security;

import static com.app.matrimony.util.Constants.ACCESS_TOKEN_VALIDITY_SECONDS;
import static com.app.matrimony.util.Constants.SIGNING_KEY;
...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateToken(AddBroker addBroker) {
        return doGenerateToken(addBroker.getUserName());
    }
