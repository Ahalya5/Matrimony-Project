...
public class StarController {
	...
	public ResponseEntity<?> updateCustomer(
		...
		try {
			starService.saveOrUpdate((Star) validationResult.getObject());
			return responseGenerator.successResponse(context, "customer.updated",
					HttpStatus.OK);
		} catch (Exception e) {
			e.printStackTrace();
			return responseGenerator.errorResponse(context, e.getMessage(), HttpStatus.BAD_REQUEST);
	...
	public ResponseEntity<?> getStarInfoById(@PathVariable("star_id") UUID id, @RequestHeader HttpHeaders httpHeader)
		...
		try {
			...
			return responseGenerator.successGetResponse(context, "star.get", starDto,
					HttpStatus.OK);
		} catch (Exception e) {
			e.printStackTrace();
			return responseGenerator.errorResponse(context, e.getMessage(), HttpStatus.BAD_REQUEST);
	...
	public ResponseEntity<?> getStarlists(@RequestHeader HttpHeaders httpHeader) throws Exception {
		...
		try {
			...
			return responseGenerator.successGetResponse(context, "stars.get", starss,
					HttpStatus.OK);
		} catch (Exception e) {
			e.printStackTrace();
			return responseGenerator.errorResponse(context, e.getMessage(), HttpStatus.BAD_REQUEST);
